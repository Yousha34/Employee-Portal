...
namespace Employee_Portal.Migrations
{
    ...
    [Migration("20260615102839_FixAdminPasswordHash")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employee_Portal.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$12$vXNCUi/FeEBJs7bLMLZDwOoC629SFso6zvcecjEfVko1SFfug1rBq",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Employee_Portal.Models.Designation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employee_Portal.Models.EmployeeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employee_Portal.Models.Employee", b =>
                {
                    ...
                    b.HasOne("Employee_Portal.Models.Designation", "Designation")
                        .WithMany()
                        .HasForeignKey("DesignationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Employee_Portal.Models.EmployeeType", "EmployeeType")
                        .WithMany("Employees")
