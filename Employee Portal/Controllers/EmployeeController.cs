...
namespace Employee_Portal.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create(EmployeeCreateUpdateViewModel vm)
        {
            ...
            vm.Designations = vm.DepartmentId != 0
                ? await _employeeService.GetDesignationsByDepartmentAsync(vm.DepartmentId)
        ...
        public async Task<IActionResult> Update(EmployeeCreateUpdateViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = $"Employee '{employee.FullName}' has been updated.";
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            TempData["Message"] = $"Employee '{employee.FullName}' has been deleted.";
            return RedirectToAction("List");
        }
        ...
        public async Task<JsonResult> GetDesignations(int departmentId)
        {
            ...
            return Json(designations.Select(d => new { id = d.Id, name = d.Name }));
        }
